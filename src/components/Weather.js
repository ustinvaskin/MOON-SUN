...
class Weather extends React.Component {
  ...
  componentDidMount() {
    ...
    // Passing data from previous page
        ...
        <div className="columns is-mobile is-multiline">
          <div className="title is-size-1-mobile" id="home-title">{this.state.data.name}
            ...
            <div className="container is-size-2 is-size-3-mobile">
              <p>Temperature: {Math.floor(this.state.data.main.temp - 273.15)} C</p>
              <p>Max Temperature: {Math.floor(this.state.data.main.temp_max - 273.15)} C</p>
              <p>Min Temperature: {Math.floor(this.state.data.main.temp_min - 273.15)} C</p>
